 ...
 * generated by Xtext
 */
package at.ac.tuwien.big.xmltext.idIdref.formatting;
...
public class IdIdrefFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private IdIdrefGrammarAccess _idIdrefGrammarAccess;
  
  @Override
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._idIdrefGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._idIdrefGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._idIdrefGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._idIdrefGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._idIdrefGrammarAccess.getML_COMMENTRule();
